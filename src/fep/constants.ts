...
export const FEP = {
  ...
  NEURO_PRECISION: {
    ...
    SEROTONIN_CONTINUOUS_BASE: 0.7,
    SEROTONIN_CONTINUOUS_SCALE: 0.5,
    OXYTOCIN_SCALE: 0.3,
    OXYTOCIN_BASE: 0.9,
    ENDORPHIN_INTEROCEPTIVE: -0.2,
    ENDORPHIN_DRIVE: 0.15,
    ENDORPHIN_RELATIONAL: 0.1,
    ENDORPHIN_ANTICIPATORY: 0.1
  },
  ...
  HIERARCHY: {
    ...
    BOTTOM_UP_WEIGHT: 0.15,
    INTEROCEPTIVE_TO_AFFECTIVE: 0.08,
    AFFECTIVE_TO_SOCIAL: 0.1,
    SOCIAL_TO_NARRATIVE: 0.12
  }
} as const

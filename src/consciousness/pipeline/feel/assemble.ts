...
export function assembleFeelOutput(
  ...
  return {
    ...
    autonomicState: chain.autonomicState,
    regulationConstraints: chain.regulationConstraints,
    ...
    emotionRegulationState: final.emotionRegulationState,
    regulationExpressionModifiers: final.regulationExpressionModifiers,

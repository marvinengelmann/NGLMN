...
import { executeCodeEvolution, proposeCodeChange } from "@/governance/evolution/code.ts"
import { applyPromptChange, loadPrompt, proposePromptChange } from "@/governance/evolution/prompt.ts"
import {
  clearPendingEvolutionProposal,
  getPendingEvolutionProposal,
  setEvolutionCycleResult,
  setPendingEvolutionProposal
} from "@/governance/evolution/state.ts"
import type {
  CodeProposal,
...
import { applyWorkflow, proposeWorkflow } from "@/governance/evolution/workflow.ts"
import { getRecentResponses } from "@/governance/security/state.ts"
import { getRecentTickSummaries } from "@/governance/workflow/engine.ts"
